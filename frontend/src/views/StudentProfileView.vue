  ...
  <main>
    <div class="outer-wrapper">
      <div class="wrapper">
        <div class="section">
          <div class="column66">
            <h1 style="margin-bottom: 10px;">{{ user.firstname || 'Naam' }} {{ user.name || 'Leerling' }}</h1>
            ...
            <div v-if="currentCourse">
              <div v-for="chapter in currentCourse.chapters" :key="chapter._id" class="chapter-section">
                <h3>{{ chapter.title }}</h3>
